...
//for the x tap dance. Put it here so it can be used in any keyma
...
void lshift_finished (qk_tap_dance_state_t *state, void *user_data) {
  ...
  switch (xtap_state.state) {
    case SINGLE_TAP: SEND_STRING ("("); reset_tap_dance (state); break;
    case SINGLE_HOLD: register_code(KC_LSFT); break;
    case DOUBLE_TAP: SEND_STRING ("{"); reset_tap_dance (state); break;
    case DOUBLE_HOLD: register_code(KC_LSFT); break;
    case TRIPLE_TAP: SEND_STRING ("["); reset_tap_dance (state); break;
...
qk_tap_dance_action_t tap_dance_actions[] = {
  [LSHIFT_DANCE]     = ACTION_TAP_DANCE_FN_ADVANCED(NULL,lshift_finished,lshift_reset),
  [RSHIFT_DANCE]     = ACTION_TAP_DANCE_FN_ADVANCED(NULL,rshift_finished,rshift_reset)
};